...
| `ohos.permission.READ_WRITE_DOWNLOAD_DIRECTORY` | 从「下载」目录**导入存档与游戏数据包**，以及把模组放进 `Download/MindustryMods/` |
...
| `ohos.permission.READ_WRITE_DOWNLOAD_DIRECTORY` | Importing saves and game-data exports from Download, and picking up mods from `Download/MindustryMods/` |
